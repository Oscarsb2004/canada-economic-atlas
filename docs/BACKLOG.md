...
| **M2a** | **The three biggest sectors in each province and territory**, on the province panel. The data is already published by province: `36100711` carries GDP by industry for all 13 in **current dollars (to 2022)** and **chained 2017 dollars (to 2025)** — only the chained basis is pulled today, so add a current-dollar pull. Rank by **current-dollar share of provincial GDP**: shares are only meaningful on an additive basis (CLAUDE.md §8), and chained levels can rank but never sum. State the year, because current dollars trail chained by three years. **Show owner-occupied dwellings both ways.** The cube publishes it separately (`5311A`), and it is imputed rent on homes people own — not market activity — yet it sits inside NAICS 53. Measured for 2022: with it, real estate is #1 in 6 of 13 and in the top three in all 13; removing it changes the top three in **all 13** (e.g. Ontario 53 · 31-33 · 52 becomes 31-33 · 52 · 54; British Columbia 53 · 23 · 21 becomes 23 · 21 · 54). The "excluding" figure is `DERIVED` (53 less 5311A) and labelled so. The ranking itself is ours too, since StatCan publishes levels, not ranks. Pairs with SEPH employment (B2) for a jobs view and with C5 for projects as a share of provincial GDP. | G2 G3 | S | |
